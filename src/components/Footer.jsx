    ...
    <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-6">
                ...
                <span className="font-bold text-xl">WildLife Connect</span>
              </div>
              <p className="text-gray-400 mb-6">Connecting businesses with nature for a sustainable future.</p>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">© 2025 WildLife Connect. All rights reserved.</p>
            <div className="flex space-x-4">
